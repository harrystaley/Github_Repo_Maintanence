    ...
    for repo in user.get_repos():
        ...
        try:
            ...
            if readme_file.name.lower() != "readme.md":
                print(f"⏩ Skipping special README file '{readme_file.name}' in '{repo.name}'")
                continue
        ...
        if not existing_readme:
            ...
            print(f"✏️ Updating README.md for '{repo.name}'...")
            try:
                if args.dry_run:
                    ...
                    print(f"✅ README.md updated for '{repo.name}'")
            except Exception as e:
                print(f"⚠️ Failed to update README.md for '{repo.name}': {e}")
        else:
